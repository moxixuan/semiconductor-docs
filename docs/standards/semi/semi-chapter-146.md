...
#2
Reported graphical data and averages; σ
r
...
total random error uncertainty,
s
T
...
measurements, considering only random sources of error, is given by
S
T
= 1.96 s
T
...
R2-4
Examples of Use of Propagation of Error Equations to Estimate the 95% Confidence Limits (Due to Random
Error Only) for the Resistivity Values of a Test Specimen

R2-4.1
Assumptions  —  One  preparation  each  of  test  specimens  and  of  calibration  specimens  (n
p
= m
p
= 1);  ten
measurements  are  taken  and  averaged  on  the  calibration  specimens  closest  in  resistivity  to  the  test  specimen  (
m
r
=
10;  five  measurements  are  taken  and  averaged  on  the  test  specimen  (
n
r
=  5);  the  test  specimen  has  a  resistivity  of
approximately 1
Ω·cm: s = 0.7%; diamond bevel polishing is used (σ
r
= 6.3%, σ
R
= 6.2%).
R2-4.2
Case I — Calibration measurements are always taken prior to measurement of each test specimen.
...
R2-4.3
Case II — Calibration measurements are not taken prior to each test specimen measurement.
...
R3-2
Calibration  Specimen  Nonuniformity  —  The  four-point  probe  method  for  measuring  the  resistivity  of  the
...
R3-3
Choosing  a  Model  for  the  Calibration  Relation  —  The  empirical  relation  between  spreading  resistance  and
...
R3-4
Loss  of  Control  of  the  Spreading-Resistance  Probes  —  Wear,  contamination,  or  other  degradation  of  the
...
R3-5
Loss of Control of Specimen Preparation Process — Contamination of specimen-polishing materials or post-
...
100 μm (or 0.004 in. approximately) and larger in thickness, independent of thickness variation and surface finish.
...
(or  10  μin.);  have  an  outside  diameter  approximately  50  mm  (or  2  in.)  larger  than  the  nominal  diameter  of  the
...
within ±130 μm (or ±0.005 in) on the circumference of a circle whose diameter is 6.35 mm (or 0.250 in.) less than
...
least 380 μm (or 0.015 in.) higher than the support pads (see Figure 1).
...
7. 1.2.2   Displacement resolution of 250 nm (or 10 μin) or better from a probed site,
...
SEMI MF657-0705 © SEMI 2003, 2005 4
7. 1.4  Surface Plate — Granite, with a working surface at least large enough to accommodate the largest ring to be
used, meeting the requirements of Laboratory Grade AA as given in Federal Specification GGG-P 463C, and with
provision for accommodating the lower probe mount.
7. 2  System Mechanical Parallelism — With the reference ring in position on the surface plate, the distance between
the top of each pad and the upper surface of the plate shall be equal to within 1.0 mm (or 40 μin.).



Figure 1
Reference Ring
Table 1  Dimensions of Reference Ring (see Figure 1)
X                                                         Y                                                         Z
Nominal Wafer
Diameter
in.                         mm                         in.                         mm                         in.                         mm
2                     in.                      1.750                     44.45                     2.515                     63.88
≥4.00 ≥101.6
3                     in.                      2.750                     69.85                     3.525                     89.54
≥5.00 ≥127.0
100 mm  93.65  113.20
≥150.0
125                        mm                                                118.65                                                138.20
≥175.0
150                        mm                                                143.65                                                163.20
≥200.0
200                        mm                                                193.65                                                213.20
≥300.0
...
7. 3  Set-up Thickness Masters — Covering a range equal to the nominal thickness of the wafer to be tested ±125 μm
(or ±0.005 in.), in approximately 50 μm (or 0.002 in.) steps (a total of 6 masters).  Each master shall have surfaces
flat to within 250 nm (or 10 μin.) and a thickness variation no greater than 1.25 μm (or 50 μin.).  The thickness of
each  master  shall  be  known  to  within  1.25  μm  (or  50  μin.).    The  diameter  of  each  master  shall  be  suitable  for  the
...
μm  (or  8  μin.)  TIR,  maximum.    The  thickness  of  the  flat  shall  be  such  as  to  permit  the  flat  to  be  placed  and
...
or equal to 1.5 μm (or 60 μin.), accept the apparatus as satisfying the parallelism requirement.
NOTE 7:  The value 1.5 μm (or 60 μin.) represents the total system transfer error of the reference ring together with the surface
plate  and  is  intentionally  greater  than  the  tolerance  of  1.0  μm  (or  40  μin.)  given  for  the  parallelism  of  the  defined  plane  of  the
...
where:
a         =
distance between the top surface of the wafer under test and the upper probe, in. (or μm),
b         =
distance between the bottom surface of the wafer under test and the lower probe, in. (or μm),
...
12. 1.7  Warp or TTV (or both) of each wafer measured, μm or (in.)
...
wafers in each set of five had warp values from about 6 to about 40 μm, and TTV values from about 1 to about 5
μm.
...
laboratory) is estimated to be 1.45 ± 0.42 μm and 0.92 ± 0.20 μm for warp and TTV, respectively.  No significant
...
13. 4  The reproducibility (between laboratories) is estimated to be 5.25 ± 3.19 μm and 3.25 ± 0.92 μm for warp and
...
7. 1.3.2  The x micrometer shall have graduations of 25 μm (0.001 in.) or smaller.
...
SEMI MF671-0705 © SEMI 2003, 2005 3
...
center, corresponding to 50 μm (0.002 in.) per division at
...
9. 1.2  With a steel scale on the viewing screen, count the number of 25 μm (0.001 in.) lines projected over a 25 mm
...
stage micrometer scale within 25 μm (0.001).  If the value
...
reference  line.    This  corresponds  to  an  offset  of  50  μm
(0.002 in.) on the wafer.  (See Figure 5.)
10. 8  Record the micrometer reading to the nearest 25 μm or
0. 001  in.  as  E
l
...
10. 11  Record  the  micrometer  reading  to  the  nearest  25  μm
or 0.001 in. as E
r
...
13. 3  The  offset  requirement  of  ¶10.7  which  was  specified  as  100  μm  (0.004  in.)  at  the  time  of  the  test  was  not
...
NOTE:  This figure illustrates the use of offset with
...
SEMI MF674-0705 © SEMI 2003, 2005 1
SEMI MF674-0705
...
type above 1 Ω·cm.  Enhanced bevel acuity is independent of conductivity-type or resistivity value.
...
8. 1  Diamond Slurry — Synthetic or natural diamond with grain size in the range 0.5 to 3 μm, inclusive, suspended
...
SEMI MF674-0705 © SEMI 2003, 2005 3
...
a.                                0.5                                μm Diamond b. 3 μm Diamond
Figure 1
...
water  slurry  of  nominal  3  to  12  μm  aluminum  oxide,  or  similar  abrasive,  and  thoroughly  cleaned  subsequent  to
lapping.
...
11. 1  Diamond  Slurry  —  Synthetic  or  natural  diamond  with  a  grain  size  in  the  range  0.05  to  0.25  μm,  inclusive,
...
11. 3  Wax — Glycol phthalate or other similar wax having a melting temperature of less than 150°C.
...
a.                     0.1                     μm Diamond, b. 0.1 μm Diamond, c. 0.5 μm Diamond,
...
www.semi.org
January   2005;   to   be   published   March   2005.      Original   edition   published   by   ASTM
...
SEMI MF928-0305 © SEMI 2005 4
9. 2  For Method B, position a gage block on the fixture (see ¶6.3) such that the known dimension can be measured
...
13. 2  At  the  recommended  magnification,  100×,  a  dimension  of  25  μm  (0.001  in.)  at  the  object  plane  produces  a
...
α, the angular deviation between the crystallographic orientation
...
10787 Berlin, Germany, Telephone: 49.30.2601-0, Fax: 49.30.2601.1263, Website: www.beuth.de
.
...
SEMI MF847-0705 © SEMI 2003, 2005 5
10  Procedure
...
(see Figure 2).
NOTE 3:  This  angle  (twice  the  Bragg  angle)  is  listed  in  Table  1  for  CuKα  radiation  for  the  recommended  reflecting  planes
...
Table 1  Bragg Angles, θ, for X-Ray Diffraction of Cu-Kα Radiation in Silicon Crystal
#1
...
and ψ
3
and the calculated value of α for each wafer.
13  Precision and Bias
...
mounting track to 1 min of arc (29 μm in 100 mm) (see Figure 4).  The vertical surface contains holes connected to a
...
SEMI MF847-0705 © SEMI 2003, 2005 7
15. 2.3  Camera — having a film holder with provision for establishing precisely a horizontal reference line.  This is
conveniently done by installing a light source with two light pipes and 75 μm (0.003 in.) diameter light collimators
...
upper surface of the mounting track to 1 min of arc (29 μm in 100 mm).
...
17. 1.4  The measured angular deviation α for each wafer, and
...
chome, Chiyoda-ku, Tokyo 101-0062, Japan, Telephone: 81.3.3518.6434, Fax: 81.3.3295.8726, Website: www.jeita.or.jp
.
...
SEMI MF951-0305 © SEMI 2003, 2005 4
...
SEMI MF951-0305 © SEMI 2003, 2005 5
8. 4.3  Position spacing shall be in 10 cm steps, center-to-center, continuing to within 5 mm of the sample center.
...
SEMI MF1049-0304 © SEMI 2003, 2004 1
SEMI MF1049-0304
...
0. 2
Ω!cm  n-  or  p-Type  —  Immediately  before  using,
