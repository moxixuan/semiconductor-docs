...
production efficiencyefficiency
=
...
max,
max
throughput  rate andWIP

cycle time efficiencyefficiency
average
WIP
theoretical
...
line
yield
finished units outscrapped units out
=
+
=
+
...
ANSI EOS/ESD S8.1 ó ESD Awareness Symbols
...
IEC    61000-4-2    ó    Electromagnetic    compatibility
...
BS   EN   50082-2   ó   Electromagnetic   Compatibility
(EMC).  Generic  Immunity  Standards.  Immunity  for
Industrial  Environments,  British  Standards  Institution
(BSI)
5

ITRS  2003  ó  International  Technology  Roadmap  for
Semiconductors
– International SEMATECH
6

MIL-STD     883     ó     Test     Method     Standard
–
...
Brussels, Belgium (www.europa.eu.int)
...
43216-5000, USA (www.dscc.dla.mil)
...
1. 5-μm gaps between features.  Approximately 800
...
ISO  14644  ñ  Cleanrooms  and  Associated  Controlled
...
191.
Avery,  L.R.,  ìCharged  Device  Model  Testing:  Trying
...
R2-8.2.2  ESD-Protective Packaging Guidelines ó The
...
0. 2ñ100 MHz.  It does not address higher frequency RF
...
5  Terminology
5. 1  Abbreviations and Acronyms
5. 1.1  CVD ó Chemical Vapor Deposition
5. 1.2  PVD ó Physical Vapor Deposition
5. 1.3  RF ó Radio Frequency
5. 1.4  VSWR ó Voltage Standing Wave Ratio
5. 2  Definitions of Terms
5. 2.1  cable    assembly    ó    the    section    of    cable
(transmission  line),  including  the  connectors,  used  to
connect various parts of the RF power delivery system.
5. 2.2  device  under  test  (DUT)  ó  the  RF  generator  to
be tested.
5. 2.3  load  impedance  ó  the  load  impedance  is  the
impedance to which a generator is attached.
5. 2.4  RF  enable  signal  ó  the  signal  that  a  generator
receives to turn on the output power.
5. 2.5  RF set point signal ó the signal that a generator
